<!--
 @Author: liang.zhu
 @Date: 2018/9/18 下午3:33
-->
<template>
  <div :style="circleSize" :class="wrapClasses">
    <svg viewBox="0 0 100 100">
      <defs>
        <linearGradient x1="0" y1="1" x2="0" y2="0" :id="strokeColor">
          <stop offset="0%" :stop-color="strokeColor"></stop>
          <stop offset="100%" :stop-color="linearColor"></stop>
        </linearGradient>
      </defs>
